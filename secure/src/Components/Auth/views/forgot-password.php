...
<div class="auth-content">
    <div class="text-center">
        ...
        <p class="text-body-secondary">No worries, we will send you reset instruction.</p>
    </div>

    <div class="card border-0">
        <div class="card-body bg-body-tertiary default-rounded">
            <form method="post" action="<?= PUBLIC_URL . "/forgot-password/submit" ?>">
                ...
                <div class="d-grid">
                    <button type="submit" class="btn btn-primary default-rounded">Send email</button>
                </div>
